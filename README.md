...
出席管理を効率的に行うためのWebアプリケーションです。ドラッグ&ドロップで簡単に出席状況を記録でき、クラス管理や名簿のインポート機能を備えています。

## 特徴

- 🎯 **直感的なUI**: ドラッグ&ドロップで出席状況を記録
...
1. 出席ボードに表示されている学生カードをドラッグ
2. 下部のステータスゾーン（出席・欠席・遅刻・早退）にドロップ
3. 自動的に出席状況が記録されます
